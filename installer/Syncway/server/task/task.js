...
var Task = (function () {
            ...
            return __generator(this, function (_a) {
                ...
                setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(this.status === 'DELETED')) return [3 /*break*/, 1];
                                return [2 /*return*/];
                            case 1:
                                if (!(this.status === 'SLEEPING')) return [3 /*break*/, 3];
                                this.status = 'WAKING-UP';
                                console.log("[TASK] " + this.name + " :: " + this.status);
                                return [4 /*yield*/, this.execution()];
                            case 2:
                                _a.sent();
                                this.status = 'SLEEPING';
                                this.run();
    ...
    Task.prototype.setExecution = function (execution) {
